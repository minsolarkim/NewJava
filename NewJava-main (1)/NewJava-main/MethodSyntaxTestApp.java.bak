class MethodSyntaxTestApp
{
	public static void main(String[] args) 
	{
		...
		System.out.println("계산 결과값(변수 사용) : "+value);
		//==> 위의 두 라인을 아래와 같이 표현했다. 주석풀고 출력결과를 확인하면...
		//System.out.println("계산 결과값(변수 사용 X) : "+methodSyntax.sum(1,1));

		System.out.println("\n=============================");
		String name = methodSyntax.getName();
		System.out.println("Field 정보 name (변수 사용): "+name);
		//==> 위의 두 라인을 아래와 같이 표현했다. 주석풀고 출력결과를 확인하면...
		//System.out.println("계산 결과값(변수 사용 X) : "+methodSyntax.getName());

		System.out.println("\n=============================");
		String add = methodSyntax.getAdd();
		System.out.println("Field 정보 add (변수 사용): "+add);
		//System.out.println("계산 결과값(변수 사용 X) : "+methodSyntax.getAdd());
